...
const PLANS = [
  {
    name: "Webサイト制作", price: "¥150,000", unit: "〜", note: "5ページ程度の場合の目安です", featured: false,
    items: ["オリジナルデザイン", "レスポンシブ対応(スマホ対応)", "お問い合わせフォーム設置", "基本的なSEO対策", "納品後1ヶ月の無料サポート"],
  },
  {
    name: "LP制作", price: "¥80,000", unit: "〜", note: "1ページ / デザイン+コーディング", featured: true,
    items: ["成果につながる構成のご提案", "オリジナルデザイン", "レスポンシブ対応", "アニメーション実装", "公開作業の代行もOK"],
  },
  {
